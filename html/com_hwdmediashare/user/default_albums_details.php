<?php
/**
 * @version    SVN $Id: default_albums_details.php 607 2012-10-17 13:00:17Z dhorsfall $
      ...
      <div class="system-unpublished">
        ...
        <div class="media-item">
          ...
          <div class="media-item-format-<?php echo $this->elementType; ?>">
             <img src="<?php echo JHtml::_('hwdicon.overlay', $this->elementType, $item); ?>" alt="<?php echo JText::_('COM_HWDMS_ALBUM'); ?>" />
          </div>
          <?php endif; ?>
