<?php
/**
 * @version    SVN $Id: default_playlists_details.php 607 2012-10-17 13:00:17Z dhorsfall $
      ...
      <div class="system-unpublished">
        ...
        <div class="media-item">
          ...
          <div class="media-item-format-<?php echo $this->elementType; ?>">
             <img src="<?php echo JHtml::_('hwdicon.overlay', $this->elementType, $item); ?>" alt="<?php echo JText::_('COM_HWDMS_PLAYLIST'); ?>" />
          </div>
          <?php endif; ?>
        ...
        <dl class="article-info">
          ...
          <?php if ($this->params->get('list_meta_likes') != 'hide') :?>
            <dd class="media-info-like"> <a href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&task=playlist.like&id=' . $item->id . '&return=' . $this->return . '&tmpl=component'); ?>"><?php echo JText::_('COM_HWDMS_LIKE'); ?></a> (<?php echo $this->escape($item->likes); ?>) <a href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&task=playlist.dislike&id=' . $item->id . '&return=' . $this->return . '&tmpl=component'); ?>"><?php echo JText::_('COM_HWDMS_DISLIKE'); ?></a> (<?php echo $this->escape($item->dislikes); ?>) </dd>
          <?php endif; ?>
