<?php
/**
 * @version    SVN $Id: albums.php 1150 2013-02-21 11:20:36Z dhorsfall $
...
<form action="<?php echo htmlspecialchars(JFactory::getURI()->toString()); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
  <div id="hwd-container"> <a name="top" id="top"></a>
    ...
    <div class="media-header">
      <h2 class="media-album-title"><?php echo JText::_('COM_HWDMS_MY_ALBUMS'); ?></h2>
      <div class="clear"></div>
      <!-- Search Filters -->
      ...
      <div class="clear"></div>
      <?php if ($canAdd) :?>
        <button type="button" class="button" onclick="javascript:window.location.href='<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=albumform&layout=edit&return='.base64_encode(JFactory::getURI())); ?>'"><?php echo JText::_('COM_HWDMS_ADD'); ?></button>
      <?php endif; ?>      
      <button type="button" class="button" onclick="Joomla.submitbutton('albums.delete')"><?php echo JText::_('COM_HWDMS_REMOVE'); ?></button>
      <button type="button" class="button" onclick="Joomla.submitbutton('albums.publish')"><?php echo JText::_('COM_HWDMS_PUBLISH'); ?></button>
      <button type="button" class="button" onclick="Joomla.submitbutton('albums.unpublish')"><?php echo JText::_('COM_HWDMS_UNPUBLISH'); ?></button>
     <div class="clear"></div>
    </div>
