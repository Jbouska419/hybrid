<?php
/**
 * @version    SVN $Id: groups.php 1152 2013-02-21 11:21:28Z dhorsfall $
...
<form action="<?php echo htmlspecialchars(JFactory::getURI()->toString()); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
  <div id="hwd-container"> <a name="top" id="top"></a>
    ...
    <div class="media-header">
      <h2 class="media-group-title"><?php echo JText::_('COM_HWDMS_MY_GROUPS'); ?></h2>
      <div class="clear"></div>
      <!-- Search Filters -->
      ...
      <div class="clear"></div>
      <?php if ($canAdd) :?>
        <button type="button" class="button" onclick="javascript:window.location.href='<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=groupform&layout=edit&return='.base64_encode(JFactory::getURI())); ?>'"><?php echo JText::_('COM_HWDMS_ADD'); ?></button>
      <?php endif; ?>       
      <button type="button" class="button" onclick="Joomla.submitbutton('groups.delete')"><?php echo JText::_('COM_HWDMS_REMOVE'); ?></button>
      <button type="button" class="button" onclick="Joomla.submitbutton('groups.publish')"><?php echo JText::_('COM_HWDMS_PUBLISH'); ?></button>
      <button type="button" class="button" onclick="Joomla.submitbutton('groups.unpublish')"><?php echo JText::_('COM_HWDMS_UNPUBLISH'); ?></button>
      <div class="clear"></div>
    </div>
