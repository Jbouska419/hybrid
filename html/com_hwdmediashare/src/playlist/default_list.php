<?php
/**
 * @version    SVN $Id: default_list.php 1226 2013-03-05 13:36:44Z dhorsfall $
...
<div class="media-list-view">
  <table class="category">
    <thead>
      <tr>
        <th width="20" class="list-order" id="tableOrdering1"> <?php  echo JHtml::_('grid.sort', 'COM_HWDMS_ORDER', 'playlist_order', $listDirn, $listOrder) ; ?>
