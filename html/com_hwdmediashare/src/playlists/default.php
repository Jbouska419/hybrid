<?php
/**
 * @version    SVN $Id: default.php 1629 2013-08-15 09:49:51Z dhorsfall $
...
<form action="<?php echo htmlspecialchars(JFactory::getURI()->toString()); ?>" method="post" name="adminForm" id="adminForm">
  <div id="hwd-container"> <a name="top" id="top"></a>
    ...
    <div class="media-header">
      <h2 class="media-playlist-title"><?php echo JText::_('COM_HWDMS_PLAYLISTS'); ?></h2>
      <!-- View Type -->
      <ul class="media-category-ls">
        ...
        <?php if ($canAdd) :?>
        <li><a href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=playlistform&layout=edit&return='.base64_encode(JFactory::getURI())); ?>" class="ls-add" title="<?php echo JText::_('COM_HWDMS_ADD_PLAYLIST'); ?>"><?php echo JText::_('COM_HWDMS_ADD_PLAYLIST'); ?></a> </li>
        <?php endif; ?>
      </ul>
      <div class="clear"></div>
      <!-- Search Filters -->
