<?php
/**
 * @version    SVN $Id: default_subscribers_details.php 607 2012-10-17 13:00:17Z dhorsfall $
  ...
  <div class="items-row cols-<?php echo (int) $this->columns;?> <?php echo 'row-'.$row ; ?>">
    ...
    <div class="item column-<?php echo $rowcount;?><?php echo ($item->published != '1' ? ' system-unpublished' : false); ?>">
      ...
      <div class="system-unpublished">
        ...
        <div class="clear"></div>
        <?php if ($this->params->get('list_meta_description') != 'hide' || $this->params->get('list_meta_created') != 'hide' || $this->params->get('list_meta_likes') != 'hide' || $this->params->get('list_meta_hits') != 'hide') : ?>
        <!-- Item Meta -->
        <dl class="article-info">
          ...
          <?php if ($this->params->get('list_meta_likes') != 'hide') :?>
            <dd class="media-info-like"> <a href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&task=user.like&id=' . $item->id . '&return=' . $this->return . '&tmpl=component'); ?>"><?php echo JText::_('COM_HWDMS_LIKE'); ?></a> (<?php echo $this->escape($item->likes); ?>) <a href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&task=user.dislike&id=' . $item->id . '&return=' . $this->return . '&tmpl=component'); ?>"><?php echo JText::_('COM_HWDMS_DISLIKE'); ?></a> (<?php echo $this->escape($item->dislikes); ?>) </dd>
          <?php endif; ?>
