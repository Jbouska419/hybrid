<?php
/**
 * @version    SVN $Id: default.php 1628 2013-08-15 09:49:25Z dhorsfall $
  ...
  <div id="hwd-container"> <a name="top" id="top"></a>
    ...
    <div class="media-header">
      ...
      <ul class="media-category-ls">
        ...
        <?php if ($canAdd) :?>
        <li><a href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=groupform&layout=edit&return='.base64_encode(JFactory::getURI())); ?>" class="ls-add" title="<?php echo JText::_('COM_HWDMS_ADD_GROUP'); ?>"><?php echo JText::_('COM_HWDMS_ADD_GROUP'); ?></a> </li>
        <?php endif; ?>
      </ul>
      <div class="clear"></div>
      <!-- Search Filters -->
