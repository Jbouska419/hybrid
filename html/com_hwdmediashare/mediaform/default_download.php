<?php
/**
 * @version    SVN $Id: default_download.php 496 2012-08-29 13:26:32Z dhorsfall $
      ...
      <table class="category">
        ...
        <?php foreach ($this->items as $id => &$item) : ?>
          <tr class="cat-list-row<?php echo ($counter % 2);?>">
            <td><a href="<?php echo hwdMediaShareDownloads::url($this->item, $item->file_type, 1); ?>"><?php echo $this->getFileType($item); ?></a></td>
